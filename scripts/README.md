...
All model diagnostics and plotting have moved to the Jupyter notebook at `analysis/grn_results_analysis.ipynb`, which supersedes the former `plot_*.py` scripts.
